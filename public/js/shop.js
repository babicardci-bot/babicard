...
function addToCart(productId) {
  ...
  // promo_stock includes both seller promo cards and admin cards when product has promo_price
...
function updateCartPayStyle(selected) {
  ...
  mobile.style.borderColor = selected === 'mobile_money' ? '#F59E0B' : 'rgba(255,255,255,0.15)';
  mobile.style.background   = selected === 'mobile_money' ? 'rgba(245,158,11,0.12)' : 'rgba(255,255,255,0.05)';
  djamo.style.borderColor  = selected === 'djamo' ? '#6C63FF' : 'rgba(255,255,255,0.15)';
  djamo.style.background    = selected === 'djamo' ? 'rgba(108,99,255,0.1)' : 'rgba(255,255,255,0.05)';
}
